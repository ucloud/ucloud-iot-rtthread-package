...
3. 创建产品  
   ...
   ![添加产品](/docs/images/添加产品.png)

4. 创建设备

   - 添加设备，点击<设备管理>、<添加设备>、<随机生成>、<生成设备个数1个>、<确定>； 
   
   ![随机添加设备](/docs/images/随机添加设备.png)
...
1.设备上下线
   ...
   ![设备上线](/docs/images/设备上线.png)
    
2.设备上行消息

   ![设备上行消息](/docs/images/设备上行消息.png)
    
3.设备下行消息

   ![设备下行消息](/docs/images/设备下行消息.png)
